...
# carriculums_tableにデータをセット
carriculums = ["国語総合", "国語表現", "現代文A", "現代文B", "古典A", "古典B", "世界史A", "世界史B", "日本史A", "日本史B", "地理A", "地理B", "現代社会", "倫理", "政治・経済", "数学I", "数学Ⅱ", "数学Ⅲ", "数学A", "数学B", "数学活用", "科学と人間生活", "物理基礎", "物理", "科学基礎", "科学", "生物基礎", "生物", "地学基礎", "地学", "理科課題研究", "体育", "保健", "音楽I", "音楽Ⅱ", "音楽Ⅲ", "美術Ⅰ", "美術Ⅱ", "美術Ⅲ", "工芸Ⅰ", "工芸Ⅱ", "工芸Ⅲ", "書道Ⅰ", "書道Ⅱ", "書道Ⅲ", "コミュニケーション英語基礎", "コミュニケーション英語Ⅰ", "コミュニケーション英語Ⅱ", "コミュニケーション英語Ⅲ", "英語表現Ⅰ", "英語表現Ⅱ", "英語会話", "家庭基礎", "家庭総合", "生活デザイン", "社会と情報", "情報の科学", "総合的な学習の時間", "LHR"]
carriculums.each { |carriculum| Carriculum.create!( name: carriculum ) }
